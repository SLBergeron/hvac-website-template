...
const privacy = () => {
  return (
    <Container
      title="Terms and Conditions | Agency Template"
      className="pb-20 max-w-[90rem] mx-auto"
      description="Terms and Conditions at Agency Template"
    >
      <div className="prose prose-sm mx-auto">
        ...
        <p>Welcome to Agency Template!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Agency Template Solutions Private Limited's Website, located at
          https://agency.Agency Template.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Agency Template if you do not agree
        ...
        <p>
          We employ the use of cookies. By accessing Agency Template, you agreed
          to use cookies in agreement with the Agency Template Solutions Private
        ...
        <p>
          Unless otherwise stated, Agency Template Solutions Private Limited
          and/or its licensors own the intellectual property rights for all
          material on Agency Template. All intellectual property rights are
          reserved. You may access this from Agency Template for your own
        ...
        <p>You must not:</p>
        <ul>
          <li>Republish material from Agency Template</li>
          <li>Sell, rent or sub-license material from Agency Template</li>
          <li>Reproduce, duplicate or copy material from Agency Template</li>
          <li>Redistribute content from Agency Template</li>
        </ul>
        ...
        <p>
          ...
          Agency Template Solutions Private Limited does not filter, edit,
          publish or review Comments prior to their presence on the website.
          Comments do not reflect the views and opinions of Agency Template
          Solutions Private Limited,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Agency Template
          Solutions Private Limited shall not be liable for the Comments or for
        ...
        <p>
          Agency Template Solutions Private Limited reserves the right to
        ...
        <p>
          You hereby grant Agency Template Solutions Private Limited a
        ...
        <p>
          ...
          the hyperlink compensates the absence of Agency Template Solutions
        ...
        <p>
          ...
          sending an e-mail to Agency Template Solutions Private Limited. Please
        ...
        <p>
          No use of Agency Template Solutions Private Limited's logo or other
